...
func TestConstraints(t *testing.T) {
	...
	t.Run("#Check", func(t *testing.T) {
		...
		t.Run("single constraint returns no violation/returns nil",
			func(t *testing.T) {
				underTest := Constraints{
		...
		t.Run("single constraint returns single violation/returns the violation",
			func(t *testing.T) {
				expected := Violations{
		...
		t.Run("single constraint returns multiple violation/returns all violations",
			func(t *testing.T) {
				expected := Violations{
					Violation{Error: errors.New("constraint violated")},
		...
		t.Run("multiple constraints return no violation/returns nil",
			func(t *testing.T) {
				underTest := Constraints{
					mockConstraint{violations: nil},
					mockConstraint{violations: nil},
		...
		t.Run("multiple constraints return violations/returns all violations",
			func(t *testing.T) {
				expected := Violations{
					Violation{Error: errors.New("constraint violated")},
					Violation{Error: errors.New("another constraint violated")},
					Violation{
						Error: errors.New("yet another constraint violated"),
					},
				}
				underTest := Constraints{
